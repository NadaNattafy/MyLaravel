...
<form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
              <strong>Email_En:</strong>
                <textarea class="form-control" style="height:150px" name="email_en" placeholder="Email_En"></textarea>
            </div>
        </div>

        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
              <strong>Mobile_En:</strong>
                <textarea class="form-control" style="height:150px" name="mobile_en" placeholder="Mobile_En"></textarea>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
              <strong>Password_En:</strong>
                <textarea class="form-control" style="height:150px" name="password_en" placeholder="Password_En"></textarea>
            </div>
        </div>
